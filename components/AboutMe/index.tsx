        ...
        <CarouselContent className="text-left">
          <CarouselItem className="lg:basis-2/3 xl:basis-1/3">
            <div className="flex h-full flex-col gap-5 rounded bg-[#373943] p-10">
              <RouteIcon strokeWidth={1.5} className="size-16 text-accent" />
          ...
          <CarouselItem className="lg:basis-2/3 xl:basis-1/3">
            <div className="flex h-full flex-col gap-5 rounded bg-[#373943] p-10">
              <CircleCheckBigIcon strokeWidth={1.5} className="mb-4 size-12 text-accent" />
          ...
          <CarouselItem className="lg:basis-2/3 xl:basis-1/3">
            <div className="flex h-full flex-col gap-5 rounded bg-[#373943] p-10">
              <TrendingUpIcon strokeWidth={1.5} className="size-16 text-accent" />
