  ...
  return (
    ...
    >
      <DrawerTrigger
        ...
        className={cn(
          'group text-primary relative hidden size-11 items-center justify-center rounded-3xl p-2 ring-2 ring-white/50 transition-[transform,box-shadow,background-color] duration-200 ease-out hover:scale-[1.03] hover:bg-white/5 hover:ring-white/80 active:scale-[0.96] lg:size-16 lg:rounded-full lg:p-4',
          {
            flex: pathname === '/shop',
          }
        )}
      >
        ...
        <div className="bg-accent text-secondary absolute top-0 right-0 z-10 aspect-square size-5 rounded-3xl p-1 text-sm leading-none tabular-nums lg:size-6 lg:rounded-full">
          {cart.length}
        </div>
      </DrawerTrigger>
      <DrawerContent
