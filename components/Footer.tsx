...
export const Footer = () => {
  ...
  return (
    <footer className="m-4 mb-0 flex flex-col items-center justify-between gap-16 rounded-xl bg-white/10 p-7 text-center lg:m-8 lg:mb-0 lg:gap-16 lg:px-24 lg:pt-32 lg:pb-8">
      <div className="flex flex-col items-center gap-6 lg:flex-row lg:gap-0 lg:divide-x lg:divide-white/20">
        <p className="font-leagueSpartan max-w-[15ch] text-3xl font-medium lg:basis-1/2 lg:pr-20 lg:text-[80px] lg:leading-none">
        ...
        <div className="flex flex-col items-center justify-center gap-6 lg:basis-1/2 lg:gap-5 lg:pl-20">
          <p className="max-w-[35ch] lg:text-2xl">{COPY.footer.description[ACTIVE_VARIANT]}</p>
