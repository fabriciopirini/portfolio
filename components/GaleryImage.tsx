    ...
    <Masonry
      ...
      render={(item: string, idx) => (
        <div className="group relative overflow-hidden rounded-lg">
          ...
          />
          <div className="hover-hover:opacity-0 hover-none:opacity-100 absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-b from-transparent to-black transition-opacity duration-300 ease-linear group-hover:opacity-100">
