...
export const Galery = () => {
  return (
    <div className="mx-auto flex max-w-[1800px] flex-wrap justify-center gap-6 pb-20 xl:gap-16">
      {PRODUCTS.map((item) => (
        <div key={item.id} className="group size-[345px] overflow-hidden rounded text-secondary lg:size-[500px]">
          <div className="flex aspect-square size-full flex-col justify-between bg-neutral-50 p-8 sm:p-10">
            <div>
              ...
              <div className="relative h-44 lg:h-80">
                ...
                <div className="hidden py-2 opacity-0 transition-opacity duration-300 ease-linear group-hover:block group-hover:opacity-100 lg:py-5">
