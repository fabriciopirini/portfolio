...
export const WorkExperience = () => {
  ...
  const isNewExperience = query.get('newExperience') === 'true'
      ...
      <div className="flex w-full flex-col gap-14 py-6 text-2xl md:pr-10 xl:pr-0">
        {isNewExperience ? (
          <>
            ...
            <p>
              Starting at <span className="text-[1.1em] font-semibold text-accent">Sportradar</span> in Oslo, Norway, as
              a Software Engineer, my focus was on enhancing our web crawler/scrapers, where I managed to boost data
              collection efficiency by 40% while reducing server load by 25%. This role was my first dive into the
              practical application of microservices architecture, achieving a 30% improvement in scalability and a 20%
              reduction in latency. It was here that I began to see the tangible benefits of Agile methodologies,
              leading to a 15% increase in team productivity and a 20% faster project delivery.
            </p>
            <p>
              In August 2020, I joined <span className="text-[1.1em] font-semibold text-accent">Oda</span>, also in
              Oslo, taking on the challenge of transitioning a major e-commerce platform to a React frontend. This move
              not only enhanced the user interface&apos;s responsiveness but also contributed to a 15% increase in
              online customer transactions. My role expanded to include participating in an on-call rotation for a
              Django monolith, crucial for managing transactions worth over $100,000 monthly. Mentoring became a passion
              during this period, where I guided 8 junior developers, significantly reducing onboarding time by 25% and
              boosting team productivity by 20%. I led initiatives to increase configuration flexibility, accommodating
              a 30% increase in product offerings without affecting system performance.
            </p>
            <p>
              My journey continued at <span className="text-[1.1em] font-semibold text-accent">Norsk Gjenvinning</span>,
              where I initially took on the role of Lead Frontend Engineer. Here, I was instrumental in developing
              frontend architectures for e-commerce platforms using React and Next.js, notably reducing page load times
              by 30% and enhancing user engagement by 25%. Working closely with UX/UI designers, we increased customer
              satisfaction scores by 20% by implementing user-friendly interfaces. Evolving into the role of Lead
              Software Engineer & Tech Lead, I managed a team of 3 software engineers, focusing on scalable e-commerce
              solutions. We achieved a 40% enhancement in UI responsiveness and a 50% reduction in load times. By
              implementing best practices in code quality and development processes, we saw a 30% reduction in bug rates
              and a 50% improvement in deployment frequency. Championing the integration of new technologies led to a
              20% improvement in project delivery speed and system reliability.
            </p>
            <p>
              Each role has been a chapter in my story, filled with learning, overcoming challenges, and making a
              tangible impact. My journey reflects a commitment to excellence, innovation, and a dedication to
              contributing positively to the tech community.
            </p>
          </>
        ) : (
          <>
