      ...
      periods: [
        {
          ...
          bullets: {
            ...
            product: [
              'Built a shared component library adopted by 3 product teams. Measured ~25% reduction in feature cycle time, tracked usage via Storybook to prioritize investment.',
              'Set up GA and SEO tooling from scratch for Norwegian client properties. Tracked conversion funnels and user flows to identify bottlenecks and prioritize fixes.',
              'Managed 5 engineers across 2 time zones. Team used GA and custom dashboards to validate that features solved the problems they were built for.',
            ],
          },
        },
        {
          ...
          bullets: {
            ...
            product: [
              'Led WCAG 2.0 AA compliance across 70+ European companies. Prioritized fixes based on user impact and usage data.',
              'Mentored 3 junior engineers (two promoted within 18 months). Embedded product habits: success criteria before starting work, outcome reviews post-deploy.',
            ],
          },
        },
      ],
      ...
      periods: [
        {
          ...
          bullets: {
            ...
            product: [
              "Built the company's first A/B experimentation program from scratch. Owned the platform (GrowthBook), ran 2 to 4 experiments/month, made go/no-go decisions based on data.",
              'Ran hero-removal experiment expecting higher conversion. It dropped. Killed the variant on data, not instinct.',
              'Shipped stripped onboarding flow with lead capture for out-of-coverage users. Conversion increased, measured via GrowthBook. Removed locale blockers so Finland and Germany launched without engineering changes.',
            ],
          },
        },
      ],
